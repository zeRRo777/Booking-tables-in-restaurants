...
class StoreRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        if ($user->hasRole('admin_chain')) {
            $requestChainId = $this->input('restaurant_chain_id');
            if (!$requestChainId) {
                return false;
            }

            return $user->administeredChains()->where('restaurant_chains.id', $requestChainId)->exists();
        }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'restaurant_chain_id' => [
                $user->hasRole('admin_chain') ? 'required' : 'nullable',
                'integer',
                'exists:restaurant_chains,id'
            ],
        ];
    }
    ...
    public function toDto(): CreateRestaurantDTO
    {
        return CreateRestaurantDTO::from($this->validated());
    }
}
